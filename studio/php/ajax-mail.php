...
$smtp->setFrom($from, 'myhost.ru');
$smtp->addReplyTo($from);
$smtp->addAddress($to);

$fields = array('user_name', 'user_email', 'user_phone', 'user_company', 'user_project');
$fields_labels = array('Имя: ', 'E-mail: ', 'Телефон: ', 'Название компании: ', 'Пара слов о проекте: ');
